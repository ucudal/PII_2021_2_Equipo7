...
namespace ClassLibrary
{
    ...
    /// </summary>
    public class CDH_SingUpReviewEnterpreneurnew : ChatDialogHandlerBase
    {
        ...
        public CDH_SingUpReviewEnterpreneurnew(ChatDialogHandlerBase next) : base(next, "registration_new_entre_verify")
        {
