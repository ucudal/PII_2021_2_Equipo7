// -----------------------------------------------------------------------
// <copyright file="CDHSalePublicationKeyWord.cs" company="Universidad Católica del Uruguay">
...
namespace ClassLibrary
{
    ...
    /// </summary>
    public class CDHSalePublicationKeyWord : ChatDialogHandlerBase
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="CDHSalePublicationKeyWord"/>.
        /// </summary>
        /// <param name="next">Siguiente handler.</param>
        public CDHSalePublicationKeyWord(ChatDialogHandlerBase next)
