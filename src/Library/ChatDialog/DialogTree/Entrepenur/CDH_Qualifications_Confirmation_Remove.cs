...
namespace ClassLibrary
{
    ...
    /// </summary>
    public class CDHQualifications_Confirmation_Remove : ChatDialogHandlerBase
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="CDHQualifications_Confirmation_Remove"/>.
        /// </summary>
        /// <param name="next">Siguiente handler.</param>
        public CDHQualifications_Confirmation_Remove(ChatDialogHandlerBase next) : base(next, "Qualifications_Confirmation_Remove")
        {
