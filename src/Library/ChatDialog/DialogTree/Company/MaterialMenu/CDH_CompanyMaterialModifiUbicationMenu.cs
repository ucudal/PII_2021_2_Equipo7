// -----------------------------------------------------------------------
// <copyright file="CDH_CompanyMaterialModifiUbicationMenu.cs" company="Universidad Católica del Uruguay">
...
namespace ClassLibrary
{
    ...
    public class CDH_CompanyMaterialModifiUbicationMenu : ChatDialogHandlerBase
    {
        ...
        public CDH_CompanyMaterialModifiUbicationMenu(ChatDialogHandlerBase next)
