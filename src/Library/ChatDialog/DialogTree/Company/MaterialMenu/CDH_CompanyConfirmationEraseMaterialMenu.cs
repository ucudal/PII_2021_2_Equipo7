// -----------------------------------------------------------------------
// <copyright file="CDH_CompanyConfirmationEraseMaterialMenu.cs" company="Universidad Católica del Uruguay">
...
namespace ClassLibrary
{
    ...
    public class CDH_CompanyConfirmationEraseMaterialMenu : ChatDialogHandlerBase
    {
        ...
        public CDH_CompanyConfirmationEraseMaterialMenu(ChatDialogHandlerBase next)
