// -----------------------------------------------------------------------
// <copyright file="CDH_CompanyMaterialModifiConfirmationMenu.cs" company="Universidad Católica del Uruguay">
...
namespace ClassLibrary
{
    ...
    public class CDH_CompanyMaterialModifiConfirmationMenu : ChatDialogHandlerBase
    {
        ...
        public CDH_CompanyMaterialModifiConfirmationMenu(ChatDialogHandlerBase next)
