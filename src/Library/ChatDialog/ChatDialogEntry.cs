...
namespace ClassLibrary
{
    ...
    public class ChatDialogEntry
    {
        ...
        public ChatDialogEntry()
        {
            ...
            ChatDialogHandlerBase handler75 = new CDHQualificationsAddBadUrl(handler74);
            ChatDialogHandlerBase handler76 = new CDHQualificationsAddConfirmationMenu(handler75);
            ChatDialogHandlerBase handler77 = new CDHQualificationsAddDocumentUrl(handler76);
            ChatDialogHandlerBase handler78 = new CDHQualificationsAddMenu(handler77);
            ChatDialogHandlerBase handler79 = new CDHQualificationsConfirmationRemove(handler78);
            ChatDialogHandlerBase handler80 = new CDHQualificationsFinalAddMenu(handler79);
            ChatDialogHandlerBase handler81 = new CDHQualificationsFinalRemove(handler80);
            ChatDialogHandlerBase handler82 = new CDHQualificationsListMenu(handler81);
            ChatDialogHandlerBase handler83 = new CDHQualificationsRemoveMenu(handler82);
            ChatDialogHandlerBase handler84 = new CDHSalePublicationCategory(handler83);
            ChatDialogHandlerBase handler85 = new CDHSalePublicationKeyWord(handler84);
            ChatDialogHandlerBase handler86 = new CDHSalePublicationLocation(handler85);
            ChatDialogHandlerBase handler87 = new CDHSearchCategoryMenu(handler86);
            ChatDialogHandlerBase handler88 = new CDHSearchKeyWordMenu(handler87);
            ChatDialogHandlerBase handler89 = new CDHSearchLocationMenu(handler88);
            ChatDialogHandlerBase handler90 = new CDHSearchPublicationMenu(handler89);
            ChatDialogHandlerBase handler91 = new CDHShowDetailsHistorySaleMenu(handler90);
            ChatDialogHandlerBase handler92 = new CDHSignUpBadCode(handler91);
            ChatDialogHandlerBase handler93 = new CDHSignUpCancel(handler92);
            ChatDialogHandlerBase handler94 = new CDHSignUpCode(handler93);
            ChatDialogHandlerBase handler95 = new CDHSignUpCompanyName(handler94);
            ChatDialogHandlerBase handler96 = new CDHSignUpCompanyTrade(handler95);
            ChatDialogHandlerBase handler97 = new CDHSignUpDoneCompanyNew(handler96);
            ChatDialogHandlerBase handler98 = new CDHSignUpDoneEntrepreneurNew(handler97);
            ChatDialogHandlerBase handler99 = new CDHSignUpDoneJoinCompany(handler98);
            ChatDialogHandlerBase handler100 = new CDHSignUpDoneSysAdmin(handler99);
            ChatDialogHandlerBase handler101 = new CDHSignUpEntrepreneurAddress(handler100);
            ChatDialogHandlerBase handler102 = new CDHSignUpEntrepreneurName(handler101);
            ChatDialogHandlerBase handler103 = new CDHSignUpEntrepreneurTrade(handler102);
            ChatDialogHandlerBase handler104 = new CDHSignUpReviewCompanyNew(handler103);
            ChatDialogHandlerBase handler105 = new CDHSignUpReviewEntrepreneurNew(handler104);
            ChatDialogHandlerBase handler106 = new CDHSignUpReviewJoinCompany(handler105);
            ChatDialogHandlerBase handler107 = new CDHSignUpReviewSysAdmin(handler106);
            ChatDialogHandlerBase handler108 = new CDHSignUpUserFirstName(handler107);
            ChatDialogHandlerBase handler109 = new CDHSignUpUserLastName(handler108);
            ChatDialogHandlerBase handler110 = new CDHSignUpVerifyCompanyJoin(handler109);
            ChatDialogHandlerBase handler111 = new CDHSignUpVerifyCompanyNew(handler110);
            ChatDialogHandlerBase handler112 = new CDHSignUpVerifyEntrepreneurNew(handler111);
            ChatDialogHandlerBase handler113 = new CDHSignUpVerifySysAdminNew(handler112);
