// -----------------------------------------------------------------------
// <copyright file="Invitation.cs" company="Universidad Católica del Uruguay">
...
namespace ClassLibrary
{
    ...
    public class Invitation : IManagableData<Invitation>
    {
        ...
        /// </summary>
        /// <value>En caso de unirnos a una company, nos unimos segun su id. En caso de no unirse a ninguna empresa, se alamacena.</value>
